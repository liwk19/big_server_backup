...
def main():
    ...
    argparser.add_argument("--pred-directory", type=str, default="../output", help="address of prediction files")
    ...
    pred_files = os.listdir(args.pred_directory)
    for pred_file in pred_files:
        print("load:", pred_file)
        pred_file = args.pred_directory + pred_file
