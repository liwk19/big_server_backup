...
from dglke.dataloader import EvalDataset # , TrainDataset, NewBidirectionalOneShotIterator
...
from embed_utils import TrainDataset, NewBidirectionalOneShotIterator
...
def main():
    ...
    assert args.async_update == False
