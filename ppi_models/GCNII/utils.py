...
def load_ppi():
    ...
    # print(g_data['directed'])
    # print(len(g_data['nodes']))
    # print(len(g_data['links']))   # 818716是总边数，没有把一条边算两次那种
    # print(g_data['multigraph'])
    # print(g_data['graph'])
    ...
    # print (features_.shape)     # (56944, 50)
    ...
    # nodes_per_graph里存储了各个graph的最终node数量（共24个graphs）
    ...
    return train_adj_list, val_adj_list, test_adj_list, train_feat, val_feat, test_feat, \
