...
from fmoe_gates.gnn_gate import GCNGate, SageGate, GATGate
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def __init__(self, num_expert=32, d_model=1024, world_size=1, mp_group=None, # (this param is deprecated)
        ...
        if gate == 'naive':
            ...
            self.gate = GATGate(d_model, num_expert, world_size, top_k, expert_drop)
        else:
            print('unknown gate')
            exit()
    ...
    def forward(self, moe_inp, graph=None):
        ...
        if isinstance(self.gate, GCNGate) or isinstance(self.gate, SageGate) or isinstance(self.gate, GATGate):
